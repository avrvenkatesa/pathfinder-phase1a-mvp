            ...
            {selectedType === "person" ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-500 max-w-md mx-auto">
                  Skills and availability tracking is designed for individual
                  contacts. For{" "}
                  {selectedType === "company" ? "companies" : "divisions"}, this
                  information is managed at the person level within the
                  organization.
                </p>
              </div>
            )}
            ...
            {selectedType === "person" ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-500 max-w-md mx-auto mb-4">
                  Workflow roles, capacity management, and task assignments are
                  managed at the individual level.{" "}
                  {selectedType === "company" ? "Companies" : "Divisions"}
                  serve as organizational containers for people who have
                  workflow capabilities.
                </p>
                <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg max-w-md mx-auto">
                  <p className="text-sm text-blue-700 dark:text-blue-300">
                    💡 <strong>Tip:</strong> Add individual contacts within this{" "}
                    {selectedType}
